  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address ,index) in addressInfo" :key="address.id">
        ...
        <p @click="changDefault(address,addressInfo)">
          <span class="s1">{{address.fullAdderss}}</span>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{userDefaultAddress.fullAdderss}}</span>
  ...
  export default {
    ...
    computed:{
      ...mapState({
        ...
        orderInfo:state=>state.trade.oderinfo
      }),
      userDefaultAddress(){
